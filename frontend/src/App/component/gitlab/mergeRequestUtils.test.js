import { countMergeRequest } from './mergeRequestUtils';
...
let mergeRequestData = [
  ...
  },
  {
    ...
    merged_at: '2019-09-07T11:16:17.520Z',
    closed_by: null,
    closed_at: null,
    created_at: '2018-04-29T08:46:00Z',
    updated_at: '2018-04-29T08:46:00Z',
    target_branch: 'master',
    source_branch: 'test1',
    upvotes: 0,
    downvotes: 0,
...
test('test countMergeRequest function', () => {
  let chartDataset = countMergeRequest(mergeRequestData, endMonth);
