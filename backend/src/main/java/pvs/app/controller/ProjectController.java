...
public class ProjectController {
    ...
    @PostMapping("/oauth/github/repos")
    public String listReposForTheOAuth(@RequestBody GitHubTokenDTO gitHubTokenDTO) {
        return repositoryService.listReposForTheOAuth(gitHubTokenDTO);
    }
